...
public class TomatoShit extends Item {
    ...
    private static final Food food = new Food.Builder().hunger(1).saturation(0.0f).effect(() -> NAUSEA_EFFECT, 1.0f).effect(() -> HUNGER_EFFECT, 1.0f).effect(() -> POISON_EFFECT, 1.0f).effect(() -> DAMAGE_EFFECT, 1.0f).setAlwaysEdible().build();
